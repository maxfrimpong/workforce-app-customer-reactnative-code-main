...
export const LoginScreen = props => {
  ...
  const onSubmit = formValues => {
    ...
    dispatch(LoginCheckRequest(formValues));
  };
    ...
    <View style={styles.mainView}>
      ...
      <KeyboardAwareScrollView>
        <View style={styles.loginWrapper}>
          <Text style={styles.detailsText}>Enter Your Mobile Number</Text>
          ...
          <PhoneFieldInput
            ...
            placeholder={'Enter Your Mobile Number'.toUpperCase()}
            flagValue={countryData.flag}
            countryCode={countryData.phoneCode}
            onSelectCode={(phoneCode, flag) =>
              setcountryData({phoneCode, flag})
            }
          />
          ...
          <View style={styles.signUpWrapper}>
            ...
            <TouchableOpacity
              onPress={() => props.navigation.navigate(screenName.signUp)}>
              <Text
                style={[
                  styles.signUpText,
                  {
