...
import { apiConfig, colors, errorToast, fonts, images, screenName } from '../../utils'
...
export const VerifyOtp = ({ navigation, route }) => {
    ...
    const otpData = useSelector(state => state?.sendOtpReducer?.sendOtpData)

    console.log(route.params, otpData)
    ...
    const handleResendOTP = () => {
        ...
        if (screenFlow === 'register') {
            sendOtpData['email'] = passedData?.email
        }
